...
void loop() {
  // set value
  String dataFromLoRa = Firebase.getString("/pythonfirebaselora/Led/-LwXvKCXODtNfIszS2OX/LED1");
  Serial.println(dataFromLoRa);
  if(dataFromLoRa == "KIRMIZI"){
    digitalWrite(kirmiziLED, HIGH);
    digitalWrite(beyazLED, LOW);
  }
  if(dataFromLoRa == "BEYAZ"){
